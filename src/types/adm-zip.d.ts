...
declare class AdmZip {
     ...
     */
    public readFileAsync(entry: string, callback: (data: Buffer, err: string) => any): void;
    /**
     * Asynchronous readFile
     * @param entry ZipEntry object
     * @param callback Called with a Buffer or Null in case of error
     * @return Buffer or Null in case of error
     */
    public readFileAsync(entry: AdmZip.IZipEntry, callback: (data: Buffer, err: string) => any): void;
    /**
     ...
     * @param encoding Optional. If no encoding is specified utf8 is used
     */
    public readAsTextAsync(fileName: string, callback: (data: string) => any, encoding?: string): void;
    /**
     * Asynchronous readAsText
     * @param entry ZipEntry object
     * @param callback Called with the resulting string.
     * @param encoding Optional. If no encoding is specified utf8 is used
     */
    public readAsTextAsync(fileName: AdmZip.IZipEntry, callback: (data: string) => any, encoding?: string): void;
    /**
     ...
     */
    public addFile(entryName: string, data: Buffer, comment?: string, attr?: number): void;
    /**
     ...
     * @return Boolean
     */
    public extractEntryTo(entryPath: string, targetPath: string, maintainEntryPath?: boolean, overwrite?: boolean): boolean;
    /**
     * Extracts the given entry to the given targetPath.
     * If the entry is a directory inside the archive, the entire directory and
     * its subdirectories will be extracted.
     ...
     * @return Boolean
     */
    public extractEntryTo(entryPath: AdmZip.IZipEntry, targetPath: string, maintainEntryPath?: boolean, overwrite?: boolean): boolean;
    /**
     ...
     */
    public extractAllToAsync(targetPath: string, overwrite: boolean, callback: (error: Error) => void): void;
    /**
     ...
     * @return Buffer
     */
    public toBuffer(onSuccess?: (buffer: Buffer) => void, onFailure?: (error: Error) => void): Buffer;
}
