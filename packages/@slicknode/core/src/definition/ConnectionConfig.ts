...
import { FieldResolver } from './FieldConfig';
...
export type ConnectionConfig = {
  ...
  /**
   * The resolve function for the connection.
   * If none is provided, the default resolver is created by the handler
   * that is set for the type that owns the relation
   */
